> **Note:** This package is a fork of [`@kubernetes/client-node`](https://www.npmjs.com/package/@kubernetes/client-node) (Apache 2.0 licensed). It modifies the async handler in the `cp` (file copy) implementation. All other functionality matches upstream.
